...
//+kubebuilder:rbac:groups=pachyderm.dejophus.dev,resources=pachyderms,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=pachyderm.dejophus.dev,resources=pachyderms/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=pachyderm.dejophus.dev,resources=pachyderms/finalizers,verbs=update
